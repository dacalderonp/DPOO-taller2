...
public class SandboxConjuntos
{
    ...
    {
    	//System.out.println(arbolCadenas);
    ...
    {
        NavigableSet<String> arbolCadenasInvertido = new TreeSet<>((cadena1, cadena2) -> cadena2.compareTo(cadena1));

        // Agrega todas las cadenas al TreeSet invertido
        arbolCadenasInvertido.addAll(arbolCadenas);

        // Convierte el TreeSet invertido a una lista
        return List.copyOf(arbolCadenasInvertido);
    }
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
        ...
        // Elimina tanto la cadena en minúsculas como en mayúsculas
        arbolCadenas.remove(cadena);
    ...
    {
        TreeSet<String> conjuntoArreglo = new TreeSet<>();
        for (String cadena : otroArreglo) {
            conjuntoArreglo.add(cadena);
        }

        // Verifica si el conjunto de cadenas contiene todos los elementos del arreglo
